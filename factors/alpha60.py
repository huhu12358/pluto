...
"""
因子描述：60 日 Jensen's alpha, 指数使用中证500指数，无风险利率使用一年期国债CGB1Y
...
计算方法：股票与指数收益率协方差/单只股票收益率标准差 -> beta;
            ...
            alpha_J = E(r_s) - [E(r_f) + beta_s_i * (E(r_i) - E(r_f))]， 均值取60日均值
"""
class ALPHA60(FactorBase):
...
if __name__ == '__main__':
    ...
    # write factor info
    factor = ALPHA60(engine, 'ALPHA60', '60 日 Jensen\'s alpha, 指数使用中证500指数，无风险利率使用一年期国债CGB1Y', 14)
    factor.update()
