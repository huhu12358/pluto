...
"""
因子描述：60 日 SharpeRatio，无风险利率使用一年期国债CGB1Y
数据调用：mercury.ashare_eod_prices, mercury.aindex_eod_prices, wind.CGBBENCHMARK
计算方法：sharpe = (E(r_s) - E(r_f))/std_s，，对式中的每一项rolling计算，window=60
"""
class SHARPERATIO60(FactorBase):
...
if __name__ == '__main__':
    ...
    # write factor info
    factor = SHARPERATIO60(engine, 'SHARPERATIO60', '60 日 SharpeRatio，无风险利率使用一年期国债CGB1Y', 14)
    factor.update()
