...
"""
因子描述：20 日 SharpeRatio，无风险利率使用一年期国债CGB1Y
数据调用：mercury.ashare_eod_prices, mercury.aindex_eod_prices, wind.CGBBENCHMARK
计算方法：sharpe = (E(r_s) - E(r_f))/std_s，，对式中的每一项rolling计算，window=20
"""
class SHARPERATIO20(FactorBase):
...
if __name__ == '__main__':
    ...
    # write factor info
    factor = SHARPERATIO20(engine, 'SHARPERATIO20', '20 日 SharpeRatio，无风险利率使用一年期国债CGB1Y', 14)
    factor.update()
